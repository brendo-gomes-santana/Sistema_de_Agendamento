...
export default function LoginRh() {
    ...
    const { LoginRh, loadingLogin } = useContext(LoginContext)
    ...
    return (
        <main className='containerLoginUser'>
            ...
            <form className='formUserLogin' onSubmit={handleLoginUser}>
                ...
                <Button type='submit'>{loadingLogin? <BiLoaderCircle className='loader'/> : <span>Entrar</span>}</Button>
            </form>
        </main>
    )
    }
